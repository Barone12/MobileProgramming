        ...
        <ScrollView>
            <View style={[styles.contentContainer,
                ...
                <View>
                    ...
                    <CustomText style={styles.title}><Text>게임의 기본 룰</Text></CustomText>
                    <CustomText style={styles.text}>
                        <Text>
                    ...
                    <CustomText style={styles.title}><Text>게임의 특징</Text></CustomText>
                    <CustomText style={styles.subtitle}><Text>1. 한국 전통 배경과 독창적인 아트 스타일</Text></CustomText>
                    <CustomText style={styles.text}>
                        <Text>
                    ...
                    <CustomText style={styles.subtitle}><Text>2. 사회적 추론과 전략적 플레이</Text></CustomText>
                    <CustomText style={styles.text}>
                        <Text>
                    ...
                    <CustomText style={styles.subtitle}><Text>3. 빠른 템포와 긴장감 넘치는 플레이</Text></CustomText>
                    ...
                    <CustomText style={styles.subtitle}><Text>4. 멀티플레이 기반의 커뮤니케이션 요소</Text></CustomText>
                    <CustomText style={styles.text}>
                        <Text>
