...
import {FlatList, SectionList, StyleSheet, Text, View, Image} from 'react-native';
    ...
    const menuSections = [
        {
            title: '설렁탕류',
            data: [
                { name: '설렁탕', price: 10000, image: require('../assets/images/Seolleongtang2024.jpg'),},
                ...
                { name: '갈비탕', price: 13000, image: require('../assets/images/galbitang.jpg') },
