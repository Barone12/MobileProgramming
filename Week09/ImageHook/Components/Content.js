    ...
    <ScrollView>
        <View style={styles.contentContainer}>
            ...
            <View>
                ...
                <Text style={styles.title}>게임의 기본 룰</Text>
                <Text style={styles.text}>
                ...
                <Text style={styles.title}>게임의 특징</Text>
                <Text style={styles.subtitle}>1. 한국 전통 배경과 독창적인 아트 스타일</Text>
                <Text style={styles.text}>
                    귀귀살전은 한국적인 미학을 적극 반영한 게임이다. 한옥을 비롯한 한국 전통 건축물, 전통 복식,
                    그리고 조선 시대를 연상시키는 무기들이 등장한다.
                </Text>
                <Text style={styles.subtitle}>2. 사회적 추론과 전략적 플레이</Text>
                <Text style={styles.text}>
                    이 게임은 단순한 서바이벌 게임이 아니라 심리전이 핵심이다. 플레이어는 자신의 목표를 찾기 위해
                    다른 플레이어와 대화하고 행동을 분석해야 한다.
                </Text>
                <Text style={styles.subtitle}>3. 빠른 템포와 긴장감 넘치는 플레이</Text>
                <Text style={styles.text}>
                ...
                <Text style={styles.subtitle}>4. 멀티플레이 기반의 커뮤니케이션 요소</Text>
                <Text style={styles.text}>
